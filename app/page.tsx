...
//   <Button
//     variant="outline"
//     className="w-20 h-10 sm:w-24 sm:h-12 md:w-28 md:h-14 text-xs sm:text-sm md:text-base"
//   >
    ...
    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
      <Card className="hover:shadow-xl transition-shadow border border-primary">
        <CardHeader className="text-center">
          <Badge className="w-fit mx-auto mb-4 bg-secondary text-white">STARTER</Badge>
      ...
      <Card className="hover:shadow-xl transition-shadow border-2 border-primary relative">
        ...
        <CardHeader className="text-center">
          <Badge className="w-fit mx-auto mb-4 bg-primary text-white">PROFESSIONAL</Badge>
      ...
      <Card className="hover:shadow-xl transition-shadow border border-secondary">
        <CardHeader className="text-center">
          <Badge className="w-fit mx-auto mb-4 bg-secondary text-white">ENTERPRISE</Badge>
